<script lang="ts">
	...
	const navItems: NavItem[] = [
		{ href: '/patient/dashboard', label: 'Overview', icon: House },
		{ href: '/patient/dashboard/protocol', label: 'Protocol', icon: ShieldPlus },
		{ href: '/patient/dashboard/workout', label: 'Workout', icon: Dumbbell },
		{ href: '/patient/dashboard/progress', label: 'Progress', icon: TrendingUp },
		{ href: '/patient/dashboard/resources', label: 'Resources', icon: Notebook },
		{ href: '/patient/dashboard/history', label: 'History', icon: FileClock },
	];
...
<div class="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr] border-muted">
